...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , wt_wr_en{vlSymsp->TOP.wt_wr_en}
    , ol_ready{vlSymsp->TOP.ol_ready}
    , pkt_sent{vlSymsp->TOP.pkt_sent}
    , wt_wr_addr{vlSymsp->TOP.wt_wr_addr}
    , wt_wr_data{vlSymsp->TOP.wt_wr_data}
    , order_count{vlSymsp->TOP.order_count}
    , net_position{vlSymsp->TOP.net_position}
    , rx_axis_tdata{vlSymsp->TOP.rx_axis_tdata}
    , tx_axis_tdata{vlSymsp->TOP.tx_axis_tdata}
    , threshold{vlSymsp->TOP.threshold}
    , tob_snapshot{vlSymsp->TOP.tob_snapshot}
    , trade_signal{vlSymsp->TOP.trade_signal}
    , computed_index{vlSymsp->TOP.computed_index}
    , rootp{&(vlSymsp->TOP)}
{
