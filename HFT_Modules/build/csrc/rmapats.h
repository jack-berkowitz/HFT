...
extern "C" {
#endif
void  rmaPropagate0_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate0_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate0_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate1_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate1_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate2_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate2_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate3_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate3_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate6_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate6_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate7_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate7_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate8_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate8_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate9_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate9_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_p_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_softmax_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_f_softmax_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate15_r_softmax_simv_daidir (UB  * pcode);
void  rmaPropagate15_wn_softmax_simv_daidir (UB  * pcode, scalar  val);
