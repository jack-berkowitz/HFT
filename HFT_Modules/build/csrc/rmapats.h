...
extern "C" {
#endif
void  rmaPropagate0_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate2_r_ipv4_udp_port_filter_simv_daidir (UB  * pcode);
void  rmaPropagate2_wn_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate3_r_ipv4_udp_port_filter_simv_daidir (UB  * pcode);
void  rmaPropagate3_wn_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_ipv4_udp_port_filter_simv_daidir (UB  * pcode, scalar  val);
